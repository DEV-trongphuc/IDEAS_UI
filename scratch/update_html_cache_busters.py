...
updates = {
    r"style\.min\.css\?v=\d+": "style.min.css?v=1781336400",
    r"script\.min\.js\?v=\d+": "script.min.js?v=1781336400",
    r"booking-modal\.min\.css\?v=\d+": "booking-modal.min.css?v=1781336400",
    r"booking-modal\.min\.js\?v=\d+": "booking-modal.min.js?v=1781336400"
}

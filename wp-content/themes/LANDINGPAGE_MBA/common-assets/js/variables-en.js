...
const IDEAS_DATA = {
    ...
    programmes: {
      ...
      `,
        ...
        IDEAS08: {
            benefits: [
                "Renowned Paris Business School (Grande École) established in 1961 in the heart of Paris, France.",
                "French National Standard Bac+5 Master's degree recognized by the French Ministry of Higher Education (Visa Bac+5 & RNCP Level 7).",
                "100% flexible online study over 12 months with integrated AI learning platform and 1:1 mentorship from IDEAS.",
                "Prestigious graduation ceremony held at Le Grand Rex Theatre in Paris with European travel opportunities."
            ],
            program_name_degree: "Master of Business Administration",
            program_benefits_degree: [
                "Prestigious French Bac+5 Master's degree awarded by a heritage Grande École in Paris.",
                "Expand global career advancement opportunities and strategic corporate leadership abilities.",
                "Globally recognized by WES (World Education Services) and international accreditation bodies."
            ],
            ...
            highlight: [
                "100% Online",
                "French Bac+5 Standard",
                "12 Months",
                "60 ECTS"
            ],
            school: "ISTEC Paris",
            country: "France",
            subjects: "<b>60</b> ECTS - <b>10</b> courses & Graduation Capstone Project",
            duration: "12 months",
            tagline: "ISTEC Business School Paris: Grande École established in 1961 in Paris, France - National Bac+5 Accredited",
            link: "/en/mba-istec",
            experience: [
                "Bachelor's degree graduate or equivalent",
                "Minimum 1-2 years of working experience",
                "Passed admissions profile screening"
            ],
            fee_course: [
                {
                    name: "Standard",
                    icon: "https://ideas.edu.vn/wp-content/uploads/2026/06/icon5.webp",
                    price: "6,500 EUR (All-inclusive)",
                    benefits: [
                        "Tuition fee with scholarship applied from development fund.",
                        "Online LMS study account and international lecture system.",
                        "Academic mentorship and local training support in Vietnam by IDEAS."
                    ]
                }
            ],
            description: "Online Master of Business Administration from ISTEC Paris – Grande École est. 1961. 12 months, 60 ECTS, accredited Bac+5 (RNCP Level 7 & Visa Bac+5).",
            degree: {
            ...
            this_subjects: [
                { name: "Strategic Management & Corporate Transformation", description: "Strategic management and corporate business transformation" },
                { name: "International Marketing & Brand Leadership", description: "Global marketing strategies and brand leadership" },
                { name: "Corporate Finance & Investment Decisions", description: "Corporate finance and strategic investment decisions" },
                { name: "Leadership & High-Performance Team Dynamics", description: "Executive leadership and high-performance team development" },
                { name: "Business Analytics & AI-Driven Decision Making", description: "Data analytics and AI-powered executive decision making" },
                { name: "Supply Chain & Operations Excellence", description: "Operations management and supply chain excellence" },
                { name: "Innovation Management & Entrepreneurship", description: "Innovation management and corporate entrepreneurship" },
                { name: "Digital Business Models & E-Commerce", description: "Digital transformation models and modern e-commerce" },
                { name: "Managerial Accounting & Cost Control", description: "Managerial accounting for cost optimization and control" },
                { name: "Business Ethics, CSR & Sustainability (ESG)", description: "Corporate ethics, CSR governance and ESG strategies" },
                { name: "Graduation Capstone Project / Thesis", description: "Applied strategic capstone project or graduation thesis", credit: 15 }
            ]
        },
        IDEAS09: {
            benefits: [
                "Terminal doctorate degree in Business Administration from a historic Grande École in Paris (established 1961).",
                "French National Standard Bac+8 degree evaluated by WES as equivalent to Earned Doctorate in USA & Canada.",
                "03 dedicated AI Copilots supporting 24/7 throughout academic literature review, data analysis, and dissertation writing.",
                "Prestigious graduation ceremony held in Paris, France with global alumni and leadership community."
            ],
            program_name_degree: "Doctor of Business Administration",
            program_benefits_degree: [
                "Prestigious French Bac+8 Doctor of Business Administration (DBA) from ISTEC Business School Paris.",
                "Elevate strategic vision, academic thought leadership, and ability to address complex business problems.",
                "High-level networking with leading international scholars, professors, and industry executives."
            ],
            link_iframe: "https://www.youtube.com/embed/ZrLeuFGGXQI",
            listImgs: [
                "/wp-content/themes/LANDINGPAGE_MBA/common-assets/images/istec/istec-grand-rex-paris.jpg",
            ...
            highlight: [
                "100% Online",
                "French Bac+8 Standard",
                "36 Months (3 Years)",
                "180 ECTS & 3 AI Copilots"
            ],
            school: "ISTEC Paris",
            country: "France",
            subjects: "<b>180</b> ECTS - <b>3</b> Research Stages & Doctoral Dissertation",
            duration: "36 months",
            tagline: "ISTEC Business School Paris: Elite academic and applied research with 3 dedicated AI Copilots & WES Earned Doctorate evaluation",
            link: "/en/dba-istec",
            experience: [
                "Master's degree (MBA, MSc, or equivalent)",
                "Minimum 3-5 years of managerial/executive experience",
                "Initial Research Proposal & Admissions Interview"
            ],
            fee_course: [
                {
                    name: "Standard",
                    icon: "https://ideas.edu.vn/wp-content/uploads/2026/06/icon5.webp",
                    price: "13,000 EUR (Full 3-year package)",
                    benefits: [
                        "All-inclusive 3-year tuition fee with scholarship applied.",
                        "Integrated 3 dedicated AI Copilots for academic research assistance.",
                        "Direct 1:1 supervision from international faculty and IDEAS academic mentors."
                    ]
                }
            ],
            description: "Online Doctor of Business Administration from ISTEC Paris – Grande École est. 1961. 3 years (180 ECTS), 3 dedicated AI Copilots, French Bac+8 & WES Earned Doctorate.",
            degree: {
            ...
            this_subjects: [
                {
                    name: "Stage 1: Research Methodology & Proposal Defense",
                    description: "<b>Year 1 (60 ECTS)</b><br/>Quantitative & qualitative research methodologies, comprehensive literature review, and formal proposal defense."
                },
                {
                    name: "Stage 2: Data Collection, Empirical Analysis & Dissertation Draft",
                    description: "<b>Year 2 (60 ECTS)</b><br/>1:1 guided research with doctoral supervisors, utilizing 3 AI Copilots for deep data analysis and initial draft synthesis."
                },
                {
                    name: "Stage 3: Dissertation Finalization & International Defense",
                    description: "<b>Year 3 (60 ECTS)</b><br/>Complete doctoral dissertation (~50,000 words) and formal defense before the ISTEC Doctoral Examination Committee."
                }
            ]
        },
    },

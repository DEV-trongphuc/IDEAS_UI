...
const IDEAS_DATA = {
    ...
    programmes: {
      ...
      <ul>
        <li><b><i class="fa-solid fa-file-invoice-dollar"></i> Học viên thanh toán 1 lần được trợ phí 20% từ IDEAS</b></li>
        ...
        <li><i class="fa-solid fa-check"></i> Thanh toán trực tiếp tại IDEAS</li>

...
function ideas_verify_sync_koda_program() {
    ...
    // 31 Attendee Certificates for KODA AI Awareness Training
    $attendees = array(
        array('cer_no' => 'IDEAS-KODA-001', 'student_id' => 'KODA-001', 'name' => 'LÊ THỊ KIM HƯƠNG', 'email' => 'huong.le@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-002', 'student_id' => 'KODA-002', 'name' => 'NGÔ HỮU THẮNG', 'email' => 'victor.ngo@kodaltd.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-003', 'student_id' => 'KODA-003', 'name' => 'NGUYỄN THỊ KIM HUÊ', 'email' => 'lucy.nguyen@kodaltd.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-004', 'student_id' => 'KODA-004', 'name' => 'ĐOÀN NGỌC DIỆU', 'email' => 'darcy.doan@kodaltd.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-005', 'student_id' => 'KODA-005', 'name' => 'NGÔ THỊ HỒNG LIÊN', 'email' => 'selina.ngo@kodaltd.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-006', 'student_id' => 'KODA-006', 'name' => 'NGUYỄN THỊ AN HÒA', 'email' => 'helen.nguyen@kodaltd.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-007', 'student_id' => 'KODA-007', 'name' => 'TRẦN THỊ THÙY AN', 'email' => 'sandy.tran@kodaltd.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-008', 'student_id' => 'KODA-008', 'name' => 'LƯƠNG THỊ HUYỀN', 'email' => 'teresa.luong@kodaltd.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-009', 'student_id' => 'KODA-009', 'name' => 'TRẦN THỊ KIM YÊN', 'email' => 'yenny.tran@kodaltd.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-010', 'student_id' => 'KODA-010', 'name' => 'NGUYỄN THỊ PHỤNG', 'email' => 'ntphung@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-011', 'student_id' => 'KODA-011', 'name' => 'PHẠM THỊ KIM LINH', 'email' => 'ptklinh@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-012', 'student_id' => 'KODA-012', 'name' => 'NGUYỄN HOÀNG THANH THẢO', 'email' => 'SarahThao@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-013', 'student_id' => 'KODA-013', 'name' => 'NGUYỄN NGỌC PHƯƠNG THẢO', 'email' => 'thao.truong@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-014', 'student_id' => 'KODA-014', 'name' => 'VÕ THỊ KIM THANH', 'email' => 'vtkthanh@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-015', 'student_id' => 'KODA-015', 'name' => 'NGUYỄN THỊ DIỄM PHƯƠNG', 'email' => 'ntdphuong@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-016', 'student_id' => 'KODA-016', 'name' => 'NGUYỄN THỊ HỒNG PHÚC', 'email' => 'nthphuc@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-017', 'student_id' => 'KODA-017', 'name' => 'BÙI THỊ KIM XUÂN', 'email' => 'xuan.bui@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-018', 'student_id' => 'KODA-018', 'name' => 'ÂU THÙY LINH', 'email' => 'atlinh@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-019', 'student_id' => 'KODA-019', 'name' => 'TRẦN NGUYỄN NGỌC TRÂM', 'email' => 'tram.tran@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-020', 'student_id' => 'KODA-020', 'name' => 'TRỊNH THỊ PHỤC SINH', 'email' => 'ttpsinh@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-021', 'student_id' => 'KODA-021', 'name' => 'MAI BÁ TRÁC', 'email' => 'mbtrac@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-022', 'student_id' => 'KODA-022', 'name' => 'VÕ THỊ BÍCH LY', 'email' => 'vtbly@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-023', 'student_id' => 'KODA-023', 'name' => 'NGUYỄN THỊ MỘNG THƯỜNG', 'email' => 'ntmthuong@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-024', 'student_id' => 'KODA-024', 'name' => 'LÊ QUANG THỊNH', 'email' => 'thinh.le@kodaltd.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-025', 'student_id' => 'KODA-025', 'name' => 'TRẦN MINH CƯỜNG', 'email' => 'cuong.tran@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-026', 'student_id' => 'KODA-026', 'name' => 'NGUYỄN THỊ HỒNG PHƯỢNG', 'email' => 'r&dmaterial@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-027', 'student_id' => 'KODA-027', 'name' => 'TRẦN QUỐC ĐẠT', 'email' => 'r&dprocess@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-028', 'student_id' => 'KODA-028', 'name' => 'HUỲNH VĂN ÚT', 'email' => 'ut.huynh@kodaltd.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-029', 'student_id' => 'KODA-029', 'name' => 'HUỲNH QUỐC NGHIÊM', 'email' => 'nghiem.huynh@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-030', 'student_id' => 'KODA-030', 'name' => 'HỒ THỊ KIM THÔNG', 'email' => 'thong.ho@kodainternational.com', 'date' => '2026-08-20'),
        array('cer_no' => 'IDEAS-KODA-031', 'student_id' => 'KODA-031', 'name' => 'PHẠM THÀNH KHÁ', 'email' => 'ptkha@kodainternational.com', 'date' => '2026-08-20'),
    );

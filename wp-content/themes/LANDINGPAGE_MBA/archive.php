...
<head>
    ...
    if ($current_page == 1) {
        ...
        if (!empty($latest_posts)) {
            ...
            if (!$featured_img) {
                ...
                $featured_img = isset($matches[1][0]) ? $matches[1][0] : 'https://ideas.edu.vn/wp-content/uploads/2026/06/Logo_IDEAS_Slg-optimized.webp';
            }
            if ($featured_img) {
    ...
    <?php if (!defined('WPSEO_VERSION') && !class_exists('RankMath') && !class_exists('AIOSEO_Base')): ?>
        <meta name="description"
            content="Khám phá các tin tức mới nhất, sự kiện giáo dục và chia sẻ từ các chuyên gia đầu ngành về các chương trình BBA, MBA, MSc AI, DBA quốc tế tại IDEAS.">
    <?php endif; ?><!-- Open Graph / Facebook -->
    <?php if (!defined('WPSEO_VERSION') && !class_exists('RankMath') && !class_exists('AIOSEO_Base')): ?>
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Tin tức & Sự kiện | IDEAS" />
        <meta property="og:description"
            content="Cập nhật tin tức giáo dục, hoạt động thực tế và học vụ chuyên nghiệp cùng các chương trình cử nhân, thạc sĩ, tiến sĩ quốc tế." />
    ...
    <div class="post-layout-wrapper">
        <main>
            ...
            if (have_posts()) {
                ...
                if ($current_page == 1) {
                    ...
                    <div class="reel-explorer-banner" style="margin-top: 24px !important; margin-bottom: 24px !important;">
                        ...
                        <div class="reel-banner-content">
                            <span class="reel-banner-tag"><svg class="svg-icon fa-circle-play fa-solid" viewBox="0 0 512 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zM188.3 147.1c-7.6 4.2-12.3 12.3-12.3 20.9l0 176c0 8.7 4.7 16.7 12.3 20.9s16.8 4.1 24.3-.5l144-88c7.1-4.4 11.5-12.1 11.5-20.5s-4.4-16.1-11.5-20.5l-144-88c-7.4-4.5-16.7-4.7-24.3-.5z"/></svg> <?php echo $is_en ? 'NEW DISCOVERY' : 'MỚI KHÁM PHÁ'; ?></span>
                ...
                ?>
                <p style="text-align: center; padding: 60px 0; color: #64748b; font-weight: 500;"><?php echo $is_en ? 'No articles found.' : 'Không có bài viết nào được tìm thấy.'; ?></p>
                <?php
            }
            ?>
        </main>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            form.addEventListener('submit', async (e) => {
                ...
                ?>
                const archiveTitle = "<?php echo esc_js($archive_title); ?>";
                ...
                const payload = {
                    ...
                    phoneNumber: phone,
                    time_dat_lich: "",
                    note_dat_lich: note ? `Đăng ký từ danh mục "${archiveTitle}" - ${chuongTrinhVal} | Ghi chú: ${note}` : `Đăng ký từ danh mục "${archiveTitle}" - ${chuongTrinhVal}`,
                ...
                const webhookPayload = {
                    ...
                    nhu_cau: note ? `Đăng ký từ danh mục "${archiveTitle}" - ${chuongTrinhVal} | Ghi chú: ${note}` : `Đăng ký từ danh mục "${archiveTitle}" - ${chuongTrinhVal}`
                };

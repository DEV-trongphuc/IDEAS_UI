...
<body <?php body_class(); ?>>
    ...
    <section class="clinic-stats-section">
        ...
        <!-- Quy trình Tháo gỡ Điểm nghẽn (Horizontal White Theme) -->
        <div class="stats-process-container" style="margin-top: 40px; padding: 40px 36px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 24px; box-shadow: 0 10px 30px -10px rgba(15, 23, 42, 0.04);">
            <h3 style="font-size: 1.15rem; font-weight: 800; color: var(--clr-navy); text-transform: uppercase; letter-spacing: 0.1em; margin: 0 0 32px; display: flex; align-items: center; justify-content: center; gap: 8px;">
                <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" style="color: var(--clr-primary);"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10h-4v4h-2v-4H7v-2h4V7h2v4h4v2z"/></svg>
                <?php echo $is_en ? 'Bottleneck Resolution Process' : 'Quy trình Tháo gỡ Điểm nghẽn'; ?>
            </h3>
            
            <div class="stats-process-grid">
                <!-- Step 1 -->
                <div class="process-step-col" style="display: flex; flex-direction: column; align-items: center; text-align: center; gap: 14px;">
                    <span class="step-num-badge" style="font-size: 0.9rem; font-weight: 800; color: #ffffff; background: #ab0e00; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 10px rgba(171, 14, 0, 0.3);">1</span>
                    <div>
                        <h4 style="font-size: 0.95rem; font-weight: 800; color: var(--clr-navy); margin: 0 0 8px;"><?php echo $is_en ? 'Step 1: Application & Pain Point Sharing' : 'Bước 1: Đăng ký & Chia sẻ Khó khăn'; ?></h4>
                        <p style="font-size: 0.85rem; color: #64748b; margin: 0; line-height: 1.6; max-width: 280px;"><?php echo $is_en ? 'Submit business status, operational barriers, and schedule an initial consultation.' : 'Doanh nghiệp cung cấp thông tin thực trạng, các rào cản vận hành và đề xuất lịch hẹn trao đổi.'; ?></p>
                    </div>
                </div>
                
                <!-- Step 2 -->
                <div class="process-step-col" style="display: flex; flex-direction: column; align-items: center; text-align: center; gap: 14px;">
                    <span class="step-num-badge" style="font-size: 0.9rem; font-weight: 800; color: #ffffff; background: #3b82f6; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 10px rgba(59, 130, 246, 0.3);">2</span>
                    <div>
                        <h4 style="font-size: 0.95rem; font-weight: 800; color: var(--clr-navy); margin: 0 0 8px;"><?php echo $is_en ? 'Step 2: Expert Board Evaluation' : 'Bước 2: Hội đồng Chuyên gia Phân tích'; ?></h4>
                        <p style="font-size: 0.85rem; color: #64748b; margin: 0; line-height: 1.6; max-width: 280px;"><?php echo $is_en ? 'Our specialized board reviews case files, identifies root causes, and evaluates corporate bottlenecks.' : 'Ban chuyên môn nghiên cứu hồ sơ, bóc tách nguyên nhân gốc rễ và đánh giá mức độ nghiêm trọng của điểm nghẽn.'; ?></p>
                    </div>
                </div>
                
                <!-- Step 3 -->
                <div class="process-step-col" style="display: flex; flex-direction: column; align-items: center; text-align: center; gap: 14px;">
                    <span class="step-num-badge" style="font-size: 0.9rem; font-weight: 800; color: #ffffff; background: #10b981; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 10px rgba(16, 185, 129, 0.3);">3</span>
                    <div>
                        <h4 style="font-size: 0.95rem; font-weight: 800; color: var(--clr-navy); margin: 0 0 8px;"><?php echo $is_en ? 'Step 3: Solution Delivery & Partnership' : 'Bước 3: Tiếp nhận Giải pháp & Đồng hành'; ?></h4>
                        <p style="font-size: 0.85rem; color: #64748b; margin: 0; line-height: 1.6; max-width: 280px;"><?php echo $is_en ? 'Receive a detailed execution roadmap and collaborate with consultants to eliminate issues.' : 'Doanh nghiệp tiếp nhận tài liệu giải pháp chi tiết và phối hợp triển khai tháo gỡ điểm nghẽn.'; ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        const CLINIC_DOCTORS = [
            ...
            { name: "Mang Viên Hoàng Nhật", title: "Tiến sĩ QTKD", specialty: isEnglish ? "Supply Chain & Healthcare Devices" : "Quản lý Chuỗi cung ứng & Thiết bị Y tế", job: "25 năm kinh nghiệm Dược phẩm. 15 năm kinh nghiệm quản lý cấp cao tại GlaxoSmithKline (GSK), Roche, Menarini, Takeda Pierre Fabre Việt Nam.", avatar: "https://ideas.edu.vn/wp-content/uploads/2026/08/cnhat_aodai.webp" },

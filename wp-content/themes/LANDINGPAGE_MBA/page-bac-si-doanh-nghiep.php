...
<body <?php body_class(); ?>>
    ...
    <script>
        ...
        const CLINIC_DOCTORS = [
            ...
            { name: "Phạm Quang Quý", title: "Tiến sĩ QTKD", specialty: isEnglish ? "Innovation & Digital Transformation" : "Đổi mới Sáng tạo & Chuyển đổi số", job: "Tốt nghiệp Ascencia Business School, chuyên sâu về Đổi mới sáng tạo và chuyển đổi số.", avatar: "https://ideas.edu.vn/wp-content/uploads/2023/04/logofavicon.webp" }
        ];

...
<body <?php body_class(); ?>>
    ...
    <section class="umef-hero">
        ...
        <div class="umef-hero-container">
            ...
            <h1><?php echo $is_en ? 'Elite Business School (Grande École) <span>in Paris</span> <br />accredited with <span>Grade de Master & Grade de Licence</span>' : 'Trường Lớn Kinh doanh <span>tại Paris</span> <br />đạt kiểm định quốc gia <span>Grade de Master & Grade de Licence</span>'; ?>
            </h1>

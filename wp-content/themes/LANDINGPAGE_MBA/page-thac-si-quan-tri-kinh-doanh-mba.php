    ...
    <main id="content">
        ...
        <section class="umef-hero" id="trang-chu">
            ...
            <div class="umef-hero-container">
                ...
                <p>Cổng kết nối các chương trình đào tạo Cử nhân (BBA) và Thạc sĩ (MBA, MSc) trực tuyến chuẩn quốc tế từ các trường Đại học danh tiếng của Thụy Sĩ. Giải pháp học tập tinh hoa, linh hoạt tối đa dành riêng cho người bận rộn.</p>
            ...
            <div class="programs-grid">
                ...
                <div class="prog-card-new">
                    ...
                    <div>
                        ...
                        <div class="prog-card-actions">
                            ...
                            <button type="button" class="prog-btn-inquire" onclick="if(typeof window.openRegModal === 'function') { window.openRegModal('swiss-umef-program-mba'); } else if(typeof window.showform === 'function') { window.showform('swiss-umef-program-mba'); }">Nhận tư vấn</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="prog-card-new">
                    <div>
                        ...
                        <div class="prog-avatar-container">
                            <img src="https://ideas.edu.vn/wp-content/uploads/2025/09/emba.png.webp"
                    ...
                    <div>
                        ...
                        <div class="prog-card-actions">
                            ...
                            <button type="button" class="prog-btn-inquire" onclick="if(typeof window.openRegModal === 'function') { window.openRegModal('swiss-umef-program-emba'); } else if(typeof window.showform === 'function') { window.showform('swiss-umef-program-emba'); }">Nhận tư vấn</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="prog-card-new">
                    <div>
                        ...
                        <div class="prog-avatar-container">
                            <img src="https://ideas.edu.vn/wp-content/uploads/2025/09/mscai.png.webp"
                                alt="MSc AI" loading="lazy" decoding="async" />
                        </div>
                        <div class="prog-card-title-group">
                    ...
                    <div>
                        ...
                        <div class="prog-card-actions">
                            ...
                            <button type="button" class="prog-btn-inquire" onclick="if(typeof window.openRegModal === 'function') { window.openRegModal('swiss-umef-program-mscai'); } else if(typeof window.showform === 'function') { window.showform('swiss-umef-program-mscai'); }">Nhận tư vấn</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="prog-card-new">
                    ...
                    <div>
                        ...
                        <div class="prog-card-actions">
                            ...
                            <button type="button" class="prog-btn-inquire" onclick="if(typeof window.openRegModal === 'function') { window.openRegModal('swiss-umef-program-mbainai'); } else if(typeof window.showform === 'function') { window.showform('swiss-umef-program-mbainai'); }">Nhận tư vấn</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="prog-card-new">
                    <div>
                        ...
                        <div class="prog-avatar-container">
                            <img src="https://ideas.edu.vn/wp-content/uploads/2026/02/TOPUP.webp"
                    ...
                    <div>
                        ...
                        <div class="prog-card-actions">
                            ...
                            <button type="button" class="prog-btn-inquire" onclick="if(typeof window.openRegModal === 'function') { window.openRegModal('swiss-umef-program-bba'); } else if(typeof window.showform === 'function') { window.showform('swiss-umef-program-bba'); }">Nhận tư vấn</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="prog-card-new">
                    ...
                    <div>
                        ...
                        <div class="prog-card-actions">
                            ...
                            <button type="button" class="prog-btn-inquire" onclick="if(typeof window.openRegModal === 'function') { window.openRegModal('swiss-umef-program-fullbba'); } else if(typeof window.showform === 'function') { window.showform('swiss-umef-program-fullbba'); }">Nhận tư vấn</button>
                        </div>
                    </div>
                </div>
        ...
        <section class="container">
            <div class="cta-banner">
                ...
                <button type="button" class="btn-ideas-primary" onclick="if(typeof window.openRegModal === 'function') { window.openRegModal('cta-banner-hub'); } else if(typeof window.showform === 'function') { window.showform('cta-banner-hub'); }">

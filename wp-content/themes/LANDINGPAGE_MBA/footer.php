...
<footer class="ideas_footer">
    <div class="footer-columns-wrap">
        ...
        <div class="footer-col-links">
            ...
            <a href="/fullbba">Global Online BBA</a>
        ...
        <div class="footer-col-contact">
            ...
            <p class="contact-item" style="display: block !important;">
                ...
                <span style="display: block; font-size: 0.8rem; opacity: 0.75; padding-left: 26px; line-height: 1.4; margin-bottom: 4px;">Do Phòng đăng ký kinh doanh - Sở tài chính Thành phố Hồ Chí Minh cấp lần đầu ngày 13/05/2025. Thay đổi lần 1 ngày 01/10/2025.</span>
                <span style="display: block; font-size: 0.8rem; opacity: 0.75; padding-left: 26px; line-height: 1.4;">Tiền thân là Viện IDEAS: 0311353167</span>
            </p>
        </div>
    </div>
    ...
    <div class="footer-middle-row">
        <div class="footer-addresses">
            <p class="address-item">
                ...
                <span><strong>Văn phòng:</strong> Tầng 4, Tòa nhà Hải Âu, 39B Trường Sơn, Phường Tân Sơn Nhất,
                    TP.HCM</span>
            </p>
        </div>
    ...
    <div class="footer-bottom-row">
        <p class="copyright-text">© <span class="copyright-year"><?php echo date('Y'); ?></span> IDEAS - Đồng hành cùng
            tri thức toàn cầu.</p>

...
$webinar_ideas_talk_url = $is_en ? '/en/webinar-ideas-talk' : '/webinar-ideas-talk';
$upcoming_aidc_count = 1; // Temporarily force badge count to 1 for the new Webinar Ideas Talk page
        ...
        <nav class="header-nav">
            ...
            <div class="nav-dropdown">
                ...
                <div class="dropdown-menu-box simple-dropdown">
                    ...
                    <a href="javascript:void(0)" onclick="openProfileBook()" class="dropdown-item-simple">
                        <svg class="svg-icon fa-book-open fa-solid" viewBox="0 0 576 512" width="16" height="16"
                ...
                <div class="dropdown-menu-box">
                    <div class="dropdown-column">
                        ...
                        <a href="<?php echo esc_url($mbainai_url); ?>" class="dropdown-item">
                            <img class="item-avatar" width="90" height="50"
                                src="https://ideas.edu.vn/wp-content/uploads/2026/07/MBA-in-AI-1.webp"
            ...
            <div class="nav-dropdown">
                ...
                <div class="dropdown-menu-box simple-dropdown">
                    ...
                    -->
                    <a href="<?php echo esc_url($webinar_ideas_talk_url); ?>" class="dropdown-item-simple">
...
<div class="mobile-menu" id="mobile-menu" aria-hidden="true" data-lenis-prevent>
    ...
    <div class="mobile-dropdown">
        ...
        <div class="mobile-dropdown-content">
            ...
            <a href="javascript:void(0)" onclick="openProfileBook()" class="mobile-dropdown-item-simple">
                <svg class="svg-icon fa-book-open fa-solid" viewBox="0 0 576 512" width="16" height="16"
                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path d="M249.6 471.5c10.8 3.8 22.4-4.1 22.4-15.5l0-377.4c0-4.2-1.6-8.4-5-11C247.4 52 202.4 32 144 32C93.5 32 46.3 45.3 18.1 56.1C6.8 60.5 0 71.7 0 83.8L0 454.1c0 11.9 12.8 20.2 24.1 16.5C55.6 460.1 105.5 448 144 448c33.9 0 79 14 105.6 23.5zm76.8 0C353 462 398.1 448 432 448c38.5 0 88.4 12.1 119.9 22.6c11.3 3.8 24.1-4.6 24.1-16.5l0-370.3c0-12.1-6.8-23.3-18.1-27.6C529.7 45.3 482.5 32 432 32c-58.4 0-103.4 20-123 35.6c-3.3 2.6-5 6.8-5 11L304 456c0 11.4 11.7 19.3 22.4 15.5z" />
                </svg> <span>IDEAS Profile</span>
            </a>
            <a href="<?php echo esc_url($org_chart_url); ?>" class="mobile-dropdown-item-simple">
                <svg class="svg-icon fa-sitemap fa-solid" viewBox="0 0 576 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M208 80c0-26.5 21.5-48 48-48l64 0c26.5 0 48 21.5 48 48l0 64c0 26.5-21.5 48-48 48l-8 0 0 40 152 0c30.9 0 56 25.1 56 56l0 32 8 0c26.5 0 48 21.5 48 48l0 64c0 26.5-21.5 48-48 48l-64 0c-26.5 0-48-21.5-48-48l0-64c0-26.5 21.5-48 48-48l8 0 0-32c0-4.4-3.6-8-8-8l-152 0 0 40 8 0c26.5 0 48 21.5 48 48l0 64c0 26.5-21.5 48-48 48l-64 0c-26.5 0-48-21.5-48-48l0-64c0-26.5 21.5-48 48-48l8 0 0-40-152 0c-4.4 0-8 3.6-8 8l0 32 8 0c26.5 0 48 21.5 48 48l0 64c0 26.5-21.5 48-48 48l-64 0c-26.5 0-48-21.5-48-48l0-64c0-26.5 21.5-48 48-48l8 0 0-32c0-30.9 25.1-56 56-56l152 0 0-40-8 0c-26.5 0-48-21.5-48-48l0-64z"/></svg> <span><?php echo $is_en ? 'Staff Structure' : 'Sơ đồ tổ chức'; ?></span>
            </a>
        ...
        <div class="mobile-dropdown-content active">
            <div class="mobile-dropdown-section">
                ...
                <a href="<?php echo esc_url($mbainai_url); ?>" class="mobile-dropdown-item">
                    <img class="item-avatar" width="90" height="50" src="https://ideas.edu.vn/wp-content/uploads/2026/07/MBA-in-AI-1.webp"
                        alt="MBA in AI" loading="lazy" decoding="async" />
                    <div class="item-content">
                        <div class="item-title">MBA in AI</div>
                        <div class="item-desc"><?php echo $is_en ? 'MBA Applied AI' : 'Thạc sĩ QTKD Ứng dụng AI'; ?></div>
    ...
    <div class="mobile-dropdown">
        ...
        <div class="mobile-dropdown-content">
            ...
            -->
            <a href="<?php echo esc_url($webinar_ideas_talk_url); ?>" class="mobile-dropdown-item-simple">
                <svg class="svg-icon fa-calendar-days fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M128 0c17.7 0 32 14.3 32 32l0 32 128 0 0-32c0-17.7 14.3-32 32-32s32 14.3 32 32l0 32 48 0c26.5 0 48 21.5 48 48l0 48L0 160l0-48C0 85.5 21.5 64 48 64l48 0 0-32c0-17.7 14.3-32 32-32s32 14.3 32 32l0 32 48 0c26.5 0 48 21.5 48 48l0 48L0 160l0-48C0 85.5 21.5 64 48 64l48 0 0-32c0-17.7 14.3-32 32-32zM0 192l448 0 0 272c0 26.5-21.5 48-48 48L48 512c-26.5 0-48-21.5-48-48L0 192zm64 80l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16zm128 0l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0zM64 400l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0zm112 16l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16z"/></svg>
                <span>IDEAS Talk</span>
                <span class="nav-badge">1</span>
            </a>

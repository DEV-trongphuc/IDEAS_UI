        ...
        <div class="timeline-container">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-card">
                    ...
                    <p><?php echo $is_en ? 'Establishment of the International Business Management Institute (IBM Institute) with the mission of training professional managers to meet the demanding needs of the high-quality workforce market in Vietnam.' : 'Thành lập Viện Quản lý Kinh doanh Quốc tế (Viện IBM) với sứ mệnh đào tạo đội ngũ nhà quản lý chuyên nghiệp, đáp ứng nhu cầu khắt khe của thị trường nhân lực chất lượng cao tại Việt Nam.'; ?></p>
                    <ul>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Marking the very first milestone of the Institute' : 'Đánh dấu cột mốc đầu tiên của Viện'; ?></li>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Overcoming challenges, asserting quality &amp; brand' : 'Vượt qua khó khăn, khẳng định chất lượng &amp; thương hiệu'; ?></li>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-card">
                    ...
                    <p><?php echo $is_en ? 'A major turning point in international business administration training in Vietnam when the Institute became the official academic partner of UBIS University (Switzerland) for the Online MBA program.' : 'Một bước ngoặt lớn trong đào tạo quản trị kinh doanh quốc tế tại Việt Nam khi Viện trở thành đối tác khoa học chính thức của Đại học UBIS (Thụy Sĩ) cho chương trình MBA Online.'; ?></p>
                    <ul>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Attaining prestigious international accreditations: IACBE, CHEA' : 'Đạt kiểm định quốc tế uy tín: IACBE, CHEA'; ?></li>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Member of leading educational organizations: EFMD, ECBE, AACSB' : 'Thành viên tổ chức giáo dục hàng đầu EFMD, ECBE, AACSB'; ?></li>
                    </ul>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-card">
                    ...
                    <p><?php echo $is_en ? 'Successfully coordinated 48 MBA cohorts in collaboration with UBIS with over 1300 students. IDEAS plays the role of a Local Service partner, providing comprehensive academic support.' : 'Liên kết thành công 48 khóa đào tạo MBA hợp tác cùng UBIS với tổng số hơn 1300 học viên tốt nghiệp và theo học. IDEAS đóng vai trò như một Local Service đồng hành hỗ trợ học vụ trọn vẹn.'; ?></p>
                    <ul>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Online programs optimizing time and cost' : 'Chương trình học trực tuyến tối ưu thời gian và chi phí'; ?></li>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Attentive and professional academic support throughout the course' : 'Hỗ trợ học vụ chu đáo, chuyên nghiệp suốt khóa học'; ?></li>
                    </ul>
                    <div class="timeline-images">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-card">
                    ...
                    <p><?php echo $is_en ? 'To adapt to global trends and contribute more strongly to the Vietnamese business community, the IBM Institute restructured and rebranded as the Institute for Development and Applied Science Exchange (IDEAS).' : 'Nhằm đáp ứng xu hướng toàn cầu và cống hiến mạnh mẽ hơn cho cộng đồng doanh nghiệp Việt Nam, Viện IBM chuyển đổi mô hình và đổi mới thương hiệu thành Viện Nghiên Cứu Phát triển và Trao đổi Khoa học Ứng dụng (IDEAS).'; ?></p>
                    <ul>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Expanding partnerships with new high-quality programs: SBS Swiss Business School, Swiss UMEF, Ascencia Business School.' : 'Hợp tác mở rộng các chương trình chất lượng cao mới: SBS Swiss Business School, Swiss UMEF, Ascencia Business School.'; ?></li>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-card">
                    ...
                    <p><?php echo $is_en ? 'IDEAS officially elevated its strategic relationship to a comprehensive partnership with Collège de Paris (owner of Ascencia Business School) and Swiss UMEF in Vietnam, expanding international Master\'s &amp; Doctoral programs.' : 'IDEAS chính thức nâng tầm mối quan hệ chiến lược lên đối tác toàn diện của College de Paris (sở hữu Ascencia Business School) và trường Swiss UMEF tại Việt Nam, mở rộng các chương trình Thạc sĩ &amp; Tiến sĩ quốc tế.'; ?></p>
                    <ul>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Maximum academic support for students of international programs' : 'Hỗ trợ học vụ tối đa cho học viên học chương trình quốc tế'; ?></li>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-card">
                    ...
                    <p><?php echo $is_en ? 'Amid the wave of Artificial Intelligence (AI) reshaping the global economy, IDEAS pioneers AI applications and brings the Master of Science in Applied Artificial Intelligence (MSc AI) program by Swiss UMEF to Vietnam.' : 'Trước làn sóng trí tuệ nhân tạo (AI) định hình lại nền kinh tế toàn cầu, IDEAS tiên phong tích cực ứng dụng AI và đưa chương trình Thạc sĩ Khoa học Trí tuệ Nhân tạo Ứng dụng (MSc AI) của Swiss UMEF về Việt Nam.'; ?></p>
                    <ul>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Strategic partnership signing with ESTIAM (France) on February 26, 2025' : 'Ký kết hợp tác chiến lược cùng trường ESTIAM (Pháp) vào ngày 26/02/2025'; ?></li>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Expanding diverse training from Bachelor to Master &amp; Doctor of Technology' : 'Mở rộng đào tạo đa dạng từ Cử nhân đến Thạc sĩ &amp; Tiến sĩ công nghệ'; ?></li>
                    </ul>
                    <div class="timeline-images">

        ...
        <div class="timeline-container">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-card">
                    ...
                    <ul>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Expanding partnerships with new high-quality programs: SBS Swiss Business School, Swiss UMEF, Ascencia Business School.' : 'Hợp tác mở rộng các chương trình chất lượng cao mới: SBS\n                            Swiss Business School, Swiss UMEF, Ascencia Business School.'; ?></li>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-card">
                    ...
                    <ul>
                        <li><svg class="svg-icon fa-check fa-solid" viewBox="0 0 448 512" width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> <?php echo $is_en ? 'Strategic partnership signing with ESTIAM (France) on February 26, 2025' : 'Ký kết hợp tác chiến lược cùng trường ESTIAM (Pháp) vào\n                            ngày 26/02/2025'; ?></li>

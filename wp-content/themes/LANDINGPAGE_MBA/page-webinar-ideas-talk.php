...
<head>
    ...
    <style>
        ...
        @keyframes text-pulse {
            ...
            100% {
                text-shadow: 0 0 8px rgba(171, 14, 0, 0.4);
            }
        }
        ...
        .section-why {
            ...
            /* Soft cool contrast grey background */
        }
...
<body <?php body_class(); ?>>
    ...
    <main id="content">
            ...
            <div class="talk-hero-container">
                ...
                <div class="talk-hero-content">
                    ...
                    <div class="talk-hero-ctas">
                        <a href="javascript:void(0)" onclick="registerForTopic('Cengage – Nâng tầm tri thức MBA/EMBA với kho học liệu chuẩn quốc tế (29/09/2026)')" class="btn-talk btn-talk-primary">
                ...
                <div class="talk-hero-visual">
                    <div class="hero-ticket-card" id="hero-ticket">
                        <span class="ticket-badge" style="background: rgba(239, 68, 68, 0.15) !important; color: #fca5a5 !important; border: 1px solid rgba(239, 68, 68, 0.4) !important;">
                            ...
                            <?php echo $is_en ? 'Upcoming Webinar • 29/09/2026' : 'Sắp diễn ra • 29/09/2026'; ?>
                        </span>
                        ...
                        <div class="ticket-speakers-section">
                            ...
                            <div class="speakers-avatars-row">
                                ...
                                <div class="speaker-avatar-wrap" title="NCS. Võ Trùng Dương">
                                    <img class="speaker-avatar-img" src="https://ideas.edu.vn/wp-content/uploads/2026/07/avatar_mr_duong.webp" alt="NCS. Võ Trùng Dương" onerror="this.src='https://secure.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=96&d=mm&r=g'">
                                </div>
                        ...
                        <div class="intro-horizontal-cards">
                            ...
                            <div class="intro-mini-card scroll-reveal stagger-item">
                                <div class="mini-card-icon">
                                    <svg viewBox="0 0 448 512" fill="currentColor" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="why-split-container">
                    ...
                    <div class="why-right-list">
                        ...
                        <div class="why-list-item scroll-reveal stagger-item">
                            ...
                            <div class="why-item-icon-wrapper">
                                <svg viewBox="0 0 448 512" fill="currentColor">
                                    <path d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C40.2 288 0 328.2 0 377.6V448c0 35.3 28.7 64 64 64h320c35.3 0 64-28.7 64-64v-70.4c0-49.4-40.2-89.6-94.4-89.6z" />
                                </svg>
                            </div>
                        ...
                        <div class="why-list-item scroll-reveal stagger-item">
                            ...
                            <div class="why-item-icon-wrapper">
                                <svg viewBox="0 0 512 512" fill="currentColor">
                                    <path d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zm0 448c-105.9 0-192-86.1-192-192S150.1 64 256 64s192 86.1 192 192s-86.1 192-192 192zm0-320c-70.6 0-128 57.4-128 128s57.4 128 128 128s128-57.4 128-128s-57.4-128-128-128zm0 192c-35.3 0-64-28.7-64-64s28.7-64 64-64s64 28.7 64 64s-28.7 64-64 64z" />
                                </svg>
                            </div>
                            <div class="why-item-content">
                        ...
                        <div class="why-list-item scroll-reveal stagger-item">
                            ...
                            <div class="why-item-icon-wrapper">
                                <svg viewBox="0 0 512 512" fill="currentColor">
                                    <path d="M256 0c141.4 0 256 114.6 256 256S397.4 512 256 512S0 397.4 0 256S114.6 0 256 0zM128 224v64h256v-64H128z" />
                                </svg>
                            </div>
                            <div class="why-item-content">
                        ...
                        <div class="why-list-item scroll-reveal stagger-item">
                            ...
                            <div class="why-item-icon-wrapper">
                                <svg viewBox="0 0 640 512" fill="currentColor">
                                    <path d="M192 256c61.9 0 112-50.1 112-112S253.9 32 192 32 80 82.1 80 144s50.1 112 112 112zm368 0c61.9 0 112-50.1 112-112s-50.1-112-112-112-112 50.1-112 112 50.1 112 112 112zm-368 32c-65.9 0-192 32.9-192 98v50c0 17.7 14.3 32 32 32h320c17.7 0 32-14.3 32-32v-50c0-65.1-126.1-98-192-98zm368 0c-17.9 0-45 4.3-73.1 12.8 29.3 20.5 49.1 52.6 49.1 89.2v50c0 4.4-.9 8.6-2.5 12.5L608 448c17.7 0 32-14.3 32-32v-50c0-65.1-126.1-98-192-98z" />
                                </svg>
                            </div>
                            <div class="why-item-content">
                    ...
                    <div class="timeline-track">
                        ...
                        <div class="timeline-node active">
                            ...
                            <div class="timeline-content-card">
                                <div>
                                    ...
                                    <div class="timeline-meta">
                                        <div class="timeline-meta-item date-item">
                                            ...
                                            <?php echo $is_en ? 'Time: 29/09/2026 (19:30 - 21:00)' : 'Thời gian: 29/09/2026 (19:30 - 21:00)'; ?>
                                        </div>
                                        <div class="timeline-meta-item" style="display: flex; align-items: center; gap: 6px;">
                                            <img src="https://assets-global.website-files.com/637501ee593ea3846f81d45e/63ea7af9128d3e56379023e6_zoom-logo-in-blue-colors-meetings-app-logotype-illustration-free-png.png" alt="Zoom" style="height: 12px; width: auto; object-fit: contain;">
                                            Zoom Meeting
                                ...
                                <div class="timeline-btn-wrapper">
                                    <a href="javascript:void(0)" onclick="registerForTopic('Cengage – Nâng tầm tri thức MBA/EMBA với kho học liệu chuẩn quốc tế (29/09/2026)')" class="btn-register-timeline">
                        ...
                        <div class="timeline-node">
                            ...
                            <div class="timeline-content-card">
                                <div>
                                    <div class="timeline-card-header">
                                        <span class="timeline-badge">
                                            <?php echo $is_en ? 'Webinar 03 • 22/10' : 'Chủ đề 03 • 22/10'; ?>
                                        </span>
                                        <span class="timeline-card-format-tag">Zoom Meeting</span>
                                    </div>
                                    ...
                                    <div class="timeline-meta">
                                        <div class="timeline-meta-item date-item">
                                            ...
                                            <?php echo $is_en ? 'Expected: 22/10/2026' : 'Dự kiến: 22/10/2026'; ?>
                                        </div>
                                        <div class="timeline-meta-item" style="display: flex; align-items: center; gap: 6px;">
                                            <img src="https://assets-global.website-files.com/637501ee593ea3846f81d45e/63ea7af9128d3e56379023e6_zoom-logo-in-blue-colors-meetings-app-logotype-illustration-free-png.png" alt="Zoom" style="height: 12px; width: auto; object-fit: contain;">
                                            Zoom Meeting
                                    ...
                                    <p class="timeline-desc"><?php echo $is_en ? 'Identify capability blind spots in career advancement, leverage AI to bridge management gaps and master executive leadership.' : 'Nhận diện điểm mù năng lực khi thăng tiến, ứng dụng AI nâng chuẩn tư duy quản trị và năng lực lãnh đạo toàn diện.'; ?></p>
                                </div>
                                <div class="timeline-btn-wrapper">
                                    <a href="javascript:void(0)" onclick="registerForTopic('Thoát Bẫy Nguyên Lý Peter: Dùng AI Vá Lỗ Hổng Năng Lực Quản Trị Trước Khi Sự Nghiệp Chững Lại (22/10/2026)')" class="btn-register-outline-timeline">
                                        <svg viewBox="0 0 512 512" fill="currentColor" width="13" height="13" style="flex-shrink: 0;" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z"/>
                                        </svg>
                        ...
                        <div class="timeline-node">
                            ...
                            <div class="timeline-content-card">
                                <div>
                                    <div class="timeline-card-header">
                                        <span class="timeline-badge">
                                            <?php echo $is_en ? 'Webinar 04 • Nov 2026' : 'Chủ đề 04 • Tháng 11'; ?>
                                        </span>
                                        <span class="timeline-card-format-tag">Zoom Meeting</span>
                                    </div>
                                    ...
                                    <p class="timeline-desc"><?php echo $is_en ? 'Key takeaways from a 15-year journey of delivering Swiss practical education standards and empowering modern business leaders.' : 'Đúc kết hành trình 15 năm kiến tạo giá trị thực chiến chuẩn Thụy Sĩ và bài học phát triển năng lực lãnh đạo thời đại mới.'; ?></p>
                                </div>
                                <div class="timeline-btn-wrapper">
                                    <a href="javascript:void(0)" onclick="registerForTopic('15 Năm Đồng Hành: Những Bài Học Từ Hành Trình Đưa Giáo Dục Thụy Sĩ Đến Việt Nam (Tháng 11/2026)')" class="btn-register-outline-timeline">
                                        <svg viewBox="0 0 512 512" fill="currentColor" width="13" height="13" style="flex-shrink: 0;" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z"/>
                                        </svg>
                                        <span><?php echo $is_en ? 'Reserve a Slot' : 'Đăng ký giữ chỗ'; ?></span>
                                ...
                                <div>
                                    ...
                                    <div class="timeline-meta">
                                        <div class="timeline-meta-item date-item">
                                            ...
                                            <?php echo $is_en ? 'Expected: Coming Soon' : 'Dự kiến: Sắp diễn ra'; ?>
                                        </div>
                                        <div class="timeline-meta-item" style="display: flex; align-items: center; gap: 6px;">
                                            <img src="https://assets-global.website-files.com/637501ee593ea3846f81d45e/63ea7af9128d3e56379023e6_zoom-logo-in-blue-colors-meetings-app-logotype-illustration-free-png.png" alt="Zoom" style="height: 12px; width: auto; object-fit: contain;">
                                            Zoom Meeting
            ...
            <div class="talk-container">
                <div class="talk-section-header">
                    ...
                    <div class="talk-section-title" style="margin-bottom: 14px !important; display: block !important;">
                        <?php echo $is_en ? 'August 13 Session <span>Highlights & Privileges</span> <span style="font-size: 0.4em; background: #64748b; color: #fff; padding: 4px 12px; border-radius: 99px; vertical-align: middle; margin-left: 8px; font-weight: 700; white-space: nowrap;">Ended</span>' : 'Giá Trị & Đặc Quyền <span>Chuyên Đề 13/08</span> <span style="font-size: 0.4em; background: #64748b; color: #fff; padding: 4px 12px; border-radius: 99px; vertical-align: middle; margin-left: 8px; font-weight: 700; white-space: nowrap;">Đã kết thúc</span>'; ?>
                    </div>
                ...
                <div class="brief-dashboard">
                    ...
                    <div class="brief-tab-panel" id="brief-tab-speakers">
                        <div class="brief-speakers-grid">
                            ...
                            <!-- Speaker 2 -->
                            <div class="brief-speaker-card">
                                <img class="brief-speaker-avatar" src="https://ideas.edu.vn/wp-content/uploads/2026/07/avatar_mr_duong.webp" alt="NCS. Võ Trùng Dương" onerror="this.src='https://secure.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=96&d=mm&r=g'">
                                <span class="brief-speaker-name">NCS. Võ Trùng Dương</span>
                ...
                <div class="theater-container">
                    ...
                    <div class="player-column">
                        ...
                        <div class="player-meta-card">
                            ...
                            <div class="meta-row">
                                <div class="meta-item">
                                    <svg viewBox="0 0 448 512" fill="currentColor" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M128 0c17.7 0 32 14.3 32 32l0 32 128 0 0-32c0-17.7 14.3-32 32-32s32 14.3 32 32l0 32 48 0c26.5 0 48 21.5 48 48l0 48L0 160l0-48C0 85.5 21.5 64 48 64l48 0 0-32c0-17.7 14.3-32 32-32zm-28.8 96c17.7 0 32 14.3 32 32v272c0 17.7-14.3 32-32 32s-32-14.3-32-32V128c0-17.7 14.3-32 32-32zm358.1 0c17.7 0 32 14.3 32 32v272c0 17.7-14.3 32-32 32s-32-14.3-32-32V128c0-17.7 14.3-32 32-32zM128 448h192V192H128v256z" />
                                    </svg>
                                    <span id="current-video-date">-</span>
                                </div>
                                <div class="meta-item">
                                    <svg viewBox="0 0 384 512" fill="currentColor" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="talk-coop">
            <div class="coop-container">
                <h2 class="coop-title">
                    <svg viewBox="0 0 640 512" width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        if (typeof isEnMode === 'undefined') {
            var isEnMode = <?php echo $is_en ? 'true' : 'false'; ?>;
        }
        const workshop_data = {
            series1: {
        ...
        window.selectedWebinarTopic = 'Cengage – Nâng tầm tri thức MBA/EMBA với kho học liệu chuẩn quốc tế (29/09/2026)';
        ...
        function registerForTopic(topicName) {
            ...
            if (mucDichSel) {
                if (topicName.toLowerCase().includes('luật') || topicName.toLowerCase().includes('kinh doanh') || topicName.toLowerCase().includes('quốc tế') || topicName.toLowerCase().includes('law')) {
                    mucDichSel.value = 'Giải quyết bài toán DN';
                } else if (topicName.toLowerCase().includes('cengage') || topicName.toLowerCase().includes('mba') || topicName.toLowerCase().includes('học liệu')) {
                    mucDichSel.value = 'Phát triển sự nghiệp';
                } else if (topicName.toLowerCase().includes('quản trị') || topicName.toLowerCase().includes('quản lý') || topicName.toLowerCase().includes('peter') || topicName.toLowerCase().includes('management')) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', async function(e) {
                ...
                const interestVal = window.selectedWebinarTopic || 'Cengage – Nâng tầm tri thức MBA/EMBA với kho học liệu chuẩn quốc tế (29/09/2026)';
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Live countdown timer to 29/09/2026 19:30
            var countDownDate = new Date("2026-09-29T19:30:00+07:00").getTime();
